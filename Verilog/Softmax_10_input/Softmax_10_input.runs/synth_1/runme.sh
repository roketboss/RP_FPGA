...
HD_PWD='C:/Users/OMEN/Assignment2_3/Softmax/Softmax.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log softmax_layer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source softmax_layer.tcl
